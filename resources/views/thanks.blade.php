...
<section class="h-full" id="home">
    ...
    <div class="container h-full flex items-center">
        <div class="flex justify-center items-center mx-auto w-full">
            <div
                class="relative top-0 bottom-0 grid items-center content-center grid-cols-1 lg:grid-cols-12 gap-4 w-full">
                ...
                <div class="col-span-4 w-full py-10 lg:pb-0 lg:pt-0">
                    <div
                        ...
                        <span class="text-gray-800 text-center">
                            Vous pouvez fermer et relancer à nouveau votre application pour bénéficier de tous les mots diponibles.</span>
                    </div>
                </div>
            </div>
        </div>

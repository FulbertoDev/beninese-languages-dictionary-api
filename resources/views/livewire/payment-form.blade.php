<div>
    <div class="flex flex-col items-center">
                ...
                <div class="flex flex-col space-y-3 my-4">
                    ...
                    <button type="submit"
                        ...
                        <svg aria-hidden="true"
                             class="inline w-6 h-6 text-white animate-spin dark:text-white fill-blue-600"
        ...
        @else
            <div class="grid gap-6 mb-6 grid-cols-1 md:w-1/2 md:mx-auto">
                <div class="flex flex-col space-y-3 my-4">
                    <div>
                        <label for="device_uuid" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                    ...
                    <button wire:click="verifyDevice"
                            class="hover:cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm  sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 mt-2 mb-12">
                        <span wire:loading.class="hidden">Continuer</span>
                        <span wire:loading>
                        <svg aria-hidden="true"
                             class="inline w-6 h-6 text-white animate-spin dark:text-white fill-blue-600"
